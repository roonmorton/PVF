...
namespace Model.Dao
{
    public class VentaDao
    {
        ...
        {
            string idVenta = "";
            string create = "insert into venta(total,idCliente,idVendedor,fecha,IVA,descuento) values('" + objVenta.Total + "','" + objVenta.IdCliente + "','" + objVenta.IdVendedor + "','" + objVenta.Fecha + "','"+objVenta.Iva+ "','" + objVenta.Descuento + "') SELECT SCOPE_IDENTITY();";
            try
            {
