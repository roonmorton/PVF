...
namespace Model.Dao
{
    public class DetalleVentaDao
    {
        ...
        {
            string create = "insert into detalleVenta(numFactura, idVenta,subTotal,idProducto,descuento,cantidad) values('" + objDetalleVenta.NumFacura + "','" + objDetalleVenta.IdVenta + "','" + objDetalleVenta.SubTotal + "','" + objDetalleVenta.IdProducto + "','" + objDetalleVenta.Descuento + "','" + objDetalleVenta.Cantidad + "')";
            try
            {
