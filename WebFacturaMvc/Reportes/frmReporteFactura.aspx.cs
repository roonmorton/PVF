...
namespace WebFacturaMvc.Reportes
{
    public partial class frmReporteFactura : System.Web.UI.Page
    {
        ...
        {           
            con = new SqlConnection("Data Source=Soporte-pc\\SQLEXPRESS;Initial Catalog=ventas;Integrated Security=True");
            if (!IsPostBack)
            {
                renderReport();
        ...
        public DataTable cargar(string codigoventa)
        {
            ...
            using (SqlConnection cn=new SqlConnection("Data Source=SOporte-pc\\SQLExpress;Initial Catalog=ventas;Integrated Security=True"))
            {
